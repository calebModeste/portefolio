...
const moveOn =(e)=>{
    ...
    // permet de changé de direction a chaque keydown
...
function moveTo(i){
        // permet de changé de direction a chaque click
        if (i ==='Up' && veloceY != 1 ) {
            veloceX=0;
            veloceY=-1;
            
        }else if (i ==='Down' && veloceY != -1) {
            veloceX=0;
            veloceY=1;
        }
        else if (i ==='Right'&& veloceX != 1) {
            veloceX=1;
            veloceY=0;
        }
        else if (i ==='Left' && veloceX != -1) {
            veloceX=-1;
            veloceY=0;
        }
}
